...
export function InputBox({ onSend, disabled = false }: Props) {
  ...
  return (
    <div className="px-5 pb-4 pt-3 border-t border-border">
      <div className="max-w-3xl mx-auto border border-border rounded-xl overflow-hidden bg-background transition-shadow duration-200 focus-within:shadow-[0_0_0_1px_var(--primary)] focus-within:border-transparent">
        <textarea
          ref={textareaRef}
          value={value}
